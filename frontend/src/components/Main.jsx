...
const Main = () => {
  ...
  return (
    <section
      className="pt-[55px] h-[calc(100vh-55px)] sm:h-[calc(100vh-55px)] md:h-auto bg-light-bg dark:bg-dark-bg flex flex-col sm:flex-row items-center w-full max-w-screen-xl mx-auto px-4 relative mb-0 mt-6 sm:mt-0"
      id="section"
    >
      ...
      <div className="parallax-content flex flex-col items-center sm:flex-row w-full z-10 relative lg:mt-40 lg:mb-40 md:mt-20 md:mb-20">
        <div id="content" className="text-center sm:text-left w-full sm:w-1/2 mb-8 sm:mb-0 sm:mr-4 flex flex-col">
          <h1 className="font-cF text-[2.25rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[4rem] font-normal leading-normal text-heading mb-4 relative inline-block self-start break-words">
            Theme Verse
          ...
          <p id="hover-paragraph" className="font-cL text-[1rem] sm:text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] font-normal leading-normal mb-8 text-black dark:text-white light:text-[#0F94B2] break-words sm:break-normal">
          ...
          <Tilt className="Tilt" options={{ max: 25 }}>
            <div className="relative w-[300px] h-[275px] md:w-[350px] md:h-[320px] lg:w-[400px] lg:h-[360px] rounded-[25px] bg-light-image-bg dark:bg-dark-image-bg transition-colors duration-300">
              <img
                ...
                alt="Logo"
                id="image"
                className="rounded-[25px] border-[5px] border-[#0F94B2] dark:border-[#A6D2EA] absolute top-[50%] right-0 w-[100%] h-[100%] transform -translate-y-1/2 transition-transform duration-500 hover:scale-105"
              />
            </div>
          </Tilt>
        </div>
