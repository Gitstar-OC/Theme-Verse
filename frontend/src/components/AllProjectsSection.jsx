...
@media (max-width: 1080px) {
  ...
  .projectItem {
    /* Tablet-specific styles for projectItem */
    animation:  !important;
  }
}
`;
  ...
  const renderProject = (project, index) => {
    ...
    return (
      ...
      >
        ...
        <div className="ml-8 mt-8 max-w-160 mr-20 projectInfo">
          {/* <div className="mr-2 border-heading border-solid border-2 dark:border-heading"></div> */}
          <h3 className="mt-2 text-[3rem] font-cF dark:text-white tablet">
            {project.name}
          </h3>
          <p className="mt-2 text-[1.5rem] font-cL dark:text-slate-300 mb-4 tablet_description">
            {project.description}
          </p>
          <div className="mr-2 border-heading border-solid border-2 dark:border-heading"></div>
          <div className="projectActions">
            <span
              className="projectAction projectItem animate-bounce text-[2.7rem] mx-16 mt-10"
