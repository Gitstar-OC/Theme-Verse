...
const Main = () => {
  return (
    <section className='h-[100vh] theme-bg flex ' id='section'>
      <div className='flex flex-col md:flex-row items-center w-full max-w-screen-xl mx-auto px-4 '>
        ...
        <div className='relative md:w-1/2 mt-8 md:mt-0'> {/* Added spacing above the image section */}
          <img
            src={HomeLogo}
            alt="Example"
            className='rounded-[25px] border-3 border-heading dark:border-third'
          />
