...
const PageInConstruction = () => {
  return (
    <div className="bg-message  rounded-[25px] relative mt-32 mb-32  ml-96 mr-[25rem]">
      <IoClose className="cursor-pointner absolute top-4 right-4 text-[#0500FF] w-[3rem] h-[3rem] hover:text-[#09FFB5] dark:hover:text-[#09FFB5]" />
      
      <div className=" flex flex-col ml-10 ">
        <div className="flex mt-10">
        <MdConstruction className="w-20 h-20 mt-4  text-[#0500FF] " />
        <h1 className="font-cF text-[3rem]  ml-10 text-black dark:text-white ">Page Under Construction</h1>
        </div>
        <p className="font-cL text-[2.25rem] text-black dark:text-white  mt-4 ml-28 mr-16">
          Oops!! it looks like this page has not been created as it needs back end which I am learning currently. 
          Sorry for this Inconvenience. 🙁
        </p>
        
        <div className="mt-4 mb-4">
          <p className="underline text-black dark:text-white  font-cL text-[1.5rem] ">Follow on other platform</p>
