...
const SuccessfulMessage = () => {
  return (
    <div className="bg-message  rounded-[25px] relative mt-32 mb-32  ml-96 mr-[25rem]">
      <IoClose className="cursor-pointer absolute top-4 right-4 text-[#0500FF] w-[3rem] h-[3rem] hover:text-[#09FFB5] dark:hover:text-[#09FFB5]" />
      ...
      <div className=" flex flex-col ml-10 ">
        ...
        Your message has been send successfully, and you will hear from  me within 24 hours. 😃 
        </p>
