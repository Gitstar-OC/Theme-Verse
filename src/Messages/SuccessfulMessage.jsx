        ...
        <div className="bg-message bg-fixed bg-cover rounded-[25px] relative mt-32 mb-32 ml-96 mr-[25rem]">
          ...
          <div className="flex flex-col ml-10">
            <div className="flex mt-10">
              <BsFillSendCheckFill className="w-16 h-16 mt-4 text-white hover:text-[#09FFB5] dark:hover:text-[#09FFB5]" />
              <h1 className="font-cF text-[3rem] ml-10 text-white">Message Sent Successfully</h1>
            </div>
            ...
            <div className="mt-4 mb-4">
              <p className="underline text-white font-cL text-[1.5rem]">Follow on other platforms</p>
