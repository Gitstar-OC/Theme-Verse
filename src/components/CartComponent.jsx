        ...
        <div className="rounded-[25px] bg-slate-800 bg-opacity-20 flex-col p-8 mb-60 sticky  top-20 self-start">
          ...
          <div className="flex flex-row justify-between w-full">
            <div className="flex flex-row">
              ...
              <HiQuestionMarkCircle className="text-[#1A3DF8] w-[1.75rem] h-[1.75rem] ml-1 mt-1 hover:text-secondary dark:hover:text-secondary cursor-pointer"/>
            </div>
          ...
          <div className="rounded-[15px] bg-[#a6d2ea] border-[#0f94b2] dark:border-[#a6d2ea] dark:bg-black border-[3px] h-[5rem] w-[300px] flex justify-center items-center cursor-pointer mt-4">
